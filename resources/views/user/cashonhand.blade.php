...
<div class="radio-container">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSj-EaNUX7Xl0MvpH9sX9_ptLkN2lv76t7v3n4SxRIlIg&s" alt="Your Image" width="50" height="50" style="border-radius: 50%;">
        ...
        <input type="radio" id="status" name="payment_details" value="Student" onclick="navigateToGcash()">
    </div><br>
    <div class="radio-container">
    ...
    <div class="radio-container"style="padding:15px; width:375px;">
        ...
        <input type="radio" id="status_cash" name="payment_details" value="cash" checked>
    </div>
<br><br><br>
<p style="font-size:20px;color:red;">Note: Failure to pay will result in automatic addition to your school fee.</p>
<div class="radio">
                <!-- Display total items -->
