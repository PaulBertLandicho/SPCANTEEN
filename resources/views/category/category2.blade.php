...
<form class="d-flex ms-auto" action="{{ route('category2index') }}" method="get">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<h3 style="text-align: center;font-size: 20px; font-weight: bold; margin: 0 auto; display: block;">Recommended
       <span style="font-size: 15px; font-weight: normal; margin-left:160px;">Lunch</span>
</h3>
<br>
<center>
<div class="products-list-container">
        <div id="product-list">
            ...
            @else
        @php
        // Fetch products from category number 2
        $products = App\Models\Product::where('category', 2)->get();
