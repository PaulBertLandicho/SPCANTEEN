...
<div class="icon-container">
    <div class="iconbar">
        ...
        <a href="category3" style="text-decoration: none;"><img src="https://cdn-icons-png.freepik.com/512/2497/2497904.png" alt="Home"><div class="icon-text" style="color: black;">&nbsp;&nbsp;Snack</div></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<form class="d-flex ms-auto" action="{{ route('category3index') }}" method="get">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<h3 style="text-align: center;font-size: 20px; font-weight: bold; margin: 0 auto; display: block;">Recommended
       <span style="font-size: 15px; font-weight: normal; margin-left:160px;">Snack</span>
</h3>
<br>
<center>
<div class="products-list-container">
        <div id="product-list">
            ...
            @else
        @php
        // Fetch products from category number 3
        $products = App\Models\Product::where('category', 3)->get();
