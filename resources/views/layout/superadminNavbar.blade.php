<center>
      <div class="containershadow">
        <div class="center-icon">
          ...
          <br>
          <div class="icon-bar">
            <a class="active" href="superadmindashboard">
              <span class="fa fa-dashboard " style="margin-left:6px;">
                <span style="margin-left:20px;">Dashboard
              </span>
            </a>
            <a class="active" href="#">
            ...
            <a class="active" href="#">
              ...
              <a class="active" href="manage_users">
              <span class="far fa-address-book" style="margin-left:6px;">
                <span style="margin-left:20px;">Manage User</span>
            </a>
            </a>
